...
urlpatterns = [
    ...
    path('dashboard/orders/<int:order_id>/details/', admin_views.admin_order_detail, name='admin_order_details_ajax'),
    path('dashboard/orders/<int:order_id>/edit/', admin_views.admin_order_edit, name='admin_order_edit'),
    path('dashboard/orders/<int:order_id>/print/', admin_views.admin_order_print, name='admin_order_print'),
    path('dashboard/orders/bulk-update-status/', admin_views.bulk_update_order_status, name='admin_bulk_update_order_status'),
